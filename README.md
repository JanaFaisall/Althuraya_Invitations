...
Designed and implemented an automation system for [Althuraya Invitations Store](https://althuraya.store/) during my internship at [Althuraya Venture Builder](https://althuraya.netlify.app/), using WhatsApp and Telegram bots with n8n to manage orders, automate pricing, and streamline workflow operations. Developed as an individual project.
